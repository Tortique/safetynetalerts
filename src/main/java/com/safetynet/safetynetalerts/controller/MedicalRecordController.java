...
public class MedicalRecordController {
    ...
    public Iterable<MedicalRecord> getMedicalRecords() { return service.getMedicalRecords();}
    ...
    public MedicalRecord saveMedicalRecord(@RequestBody MedicalRecord medicalRecord) { return service.saveMedicalRecord(medicalRecord);}
